...
## Project Structure
    ...
    ├── testapiautotasksnew_90718  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_90718`
...
2. Clone this repo and `cd testapiautotasksnew_90718`
